...
import com.example.mapdirection.directionhelpers.FetchURL;
...
public class MainActivity extends AppCompatActivity  implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        place1 = new MarkerOptions().position(new LatLng(19.1860408, 72.9758837)).title("Location 1");
        place2 = new MarkerOptions().position(new LatLng(19.22193, 72.9772656)).title("Location 2");
